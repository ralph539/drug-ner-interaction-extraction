#!/usr/bin/env python3
# [MOD-2.2] error_strata.py — same stratified error analysis as 2.1's
# but applied to the NN champion's predictions. Splits errors by (a)
# document source (MedLine vs DrugBank) and (b) sentence-length bucket.
import sys, argparse
